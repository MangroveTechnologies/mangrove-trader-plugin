...
4. Present results with scoring breakdown:
...
5. If all metrics are null, note that scoring runs at midnight UTC and the trader may not have enough closed trades yet
